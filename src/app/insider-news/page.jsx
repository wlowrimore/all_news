import InsiderNews from "../components/insiderNews/InsiderNews"
import { wait } from "../utils/wait"

export const metadata = {
  title: 'News Link Now | Insider News',
...
const page = async () => {
  await wait(2500)
  return (
    <div className='flex min-h-screen flex-col items-center justify-between pt-14 md:p-6 lg:p-8 xl:p-10 2xl:p-24 xl:mx-12 2xl:mx-[16rem]'>
      <InsiderNews />
    </div>
  )
}
