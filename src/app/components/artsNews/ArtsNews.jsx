...
const ArtsNews = () => {
  ...
  const firstArticleWithMultimedia = artsArticles.find((article) => article.multimedia && article.multimedia.length > 0)
  ...
  return (
    <div className='max-w-7xl mx-auto'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
        ...
        {artsArticles.filter((artsArticle) => artsArticle.multimedia && artsArticle.multimedia.length > 0).map((artsArticle, index) => (
