...
const TravelNews = () => {
  ...
  return (
    <div className='max-w-7xl mx-auto'>
      <h1 className={`${noticia.className} text-3xl px-4 md:text-4xl 2xl:text-5xl`}>Travel News</h1>
      <h2 className={`${noticia.className} px-4 md:text-lg 2xl:text-3xl`}>Travel news you should know about</h2>
