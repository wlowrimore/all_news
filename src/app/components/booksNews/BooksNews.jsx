...
const BooksNews = () => {
  ...
  return (
    <div className='max-w-7xl mx-auto'>
      <h1 className={`${noticia.className} text-3xl px-4 md:text-4xl 2xl:text-5xl`}>Literary News</h1>
      <h2 className={`${noticia.className} px-4 md:text-lg 2xl:text-3xl`}>Get the latest news on literature</h2>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
        ...
        {booksArticles && booksArticles.filter((booksArticle) => booksArticle.multimedia && booksArticle.multimedia.length > 0).map((booksArticle, index) => (
