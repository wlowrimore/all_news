...
const BusinessNews = () => {
  ...
  const firstArticleWithMultimedia = businessArticles.find((article) => article.multimedia && article.multimedia.length > 0)
  ...
  return (
    <div className='max-w-7xl mx-auto'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
        ...
        {businessArticles.filter((businessArticle) => businessArticle.multimedia && businessArticle.multimedia.length > 0).map((businessArticle, index) => (
