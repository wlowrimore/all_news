...
const MagazineNews = () => {
  ...
  return (
    <div className='max-w-7xl mx-auto'>
      <h1 className={`${noticia.className} 2xl:text-5xl px-4 pb-2`}>Magazine News</h1>
      <h2 className={`${noticia.className} 2xl:text-3xl px-4`}>Intresting Articles on various topics</h2>
